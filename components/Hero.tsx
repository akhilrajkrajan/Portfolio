...
const tags = ["ESG", "CSRD", "EU Taxonomy", "Power BI", "ESRS", "Financial Controlling"];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <a
                href={personalInfo.resumeUrl} download
                className="shine-effect inline-flex items-center gap-2.5 px-6 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-600/25 text-sm"
              >
              ...
              >
                <LinkedInIcon size={16} className="text-blue-500" /> LinkedIn
              </a>
            </motion.div>
          </div>
